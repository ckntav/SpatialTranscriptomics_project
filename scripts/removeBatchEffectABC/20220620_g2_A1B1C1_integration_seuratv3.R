...
VlnPlot(sampleA1, features = c("nFeature_Spatial","nCount_Spatial","percent.mt","percent.rbp"), ncol = 4)
...
VlnPlot(sampleB1, features = c("nFeature_Spatial","nCount_Spatial","percent.mt","percent.rbp"), ncol = 4)
...
VlnPlot(sampleC1, features = c("nFeature_Spatial","nCount_Spatial","percent.mt","percent.rbp"), ncol = 4)
...
#####
DimPlot(sample_seurat, reduction = "umap", group.by = "orig.ident") + plot_annotation(title = "A1B1C1, before integration")
...
#####
DimPlot(sample_seurat, reduction = "umap", group.by = "orig.ident") + plot_annotation(title = "A1B1C1, after integration (Seurat 3)")
...
write.table(split.umap, file = "output/correctedA1B1C1/20220620_g2_corrected_umap_A1B1C1.csv", sep = ",", quote = F, row.names = F, col.names = T)
...
write.table(split.cluster, file="output/correctedA1B1C1/20220620_g2_corrected_clusters_A1B1C1.csv", sep = ",", quote = F, row.names = F, col.names = T)
