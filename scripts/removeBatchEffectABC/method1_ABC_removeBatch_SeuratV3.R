...
# saveRDS
saveRDS(sample_seurat, file = "output/ABC_object/20220622_ABC_object_method1.rds")
...
write.table(split.umap, file = "output/correctedABC/20220621_method1_corrected_umap_ABC.csv", sep = ",", quote = F, row.names = F, col.names = T)
...
write.table(split.cluster, file="output/correctedABC/20220621_method1_corrected_clusters_ABC.csv", sep = ",", quote = F, row.names = F, col.names = T)